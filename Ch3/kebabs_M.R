...
seqs <- readAAStringSet(file.path(getwd(), "R_cook", "Ch3", "ecoli_proteins.fa"))
classes <- readr::read_csv(file.path(getwd(), "R_cook", "Ch3", "ecoli_protein_classes.txt"), col_names = TRUE)
