...
#####then set up the genome object that will be the base for our karotype
...
genome_gr <- makeGRangesFromDataFrame(genome_df)
###set up SNP position we will draw on the markers
...
####create some labels for the markers
...
kpPlotMarkers(kp, snps_gr, labels = snp_labels)
kpLines(kp, numeric_data_gr, y = numeric_da
