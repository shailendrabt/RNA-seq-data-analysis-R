#######load library packages and define some functions that create Granges from common files
...
getwd()
######actually create some GRanges object using those functions
gr_from_gff <- get_annotated_regions_from_gff(file.path(getwd(), "R_cook", "Ch2", "arabidopsis_chr4.gff"))
gr_from_txt <- get_granges_from_text(file.path(getwd(), "R_cook", "Ch2", "arabidopsis_chr4.txt"))
